...
export const ChefSingle = () => {
  ...
  function make(){
    axios.post('/order/make/'+id, {name:user.name}).then(({data})=>{
        setOrder(data)
    })
  } 
  function unmake(){
  ...
  return (
    <div className=" p-5 text-black px-24">
      ...
      <Link to={'/Chef'} className="text-black mb-4">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M15.75 19.5 8.25 12l7.5-7.5" />
    ...
    <div className=" text-black text-2xl mb-40 mt-8 bg-gray-100 p-4">
        ...
        <div className="p-3  w-full absolute bottom-0">
            { order?.made == true? 
          <span className="text-2xl text-green-500 mb-2">ትዛዙ ተሰርቷል</span>:
          <span className="text-2xl text-red-500 mb-2">ትዛዙ አልተሰራም </span>}
